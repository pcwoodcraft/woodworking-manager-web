// Číselníky a logika modulu CRM (dopyty, aktivity, úlohy, reklamácie). Konštanty kartotéky
// zákazníkov (CUSTOMER_TYPES, CONTACT_TYPES, customerDisplayName, …) sú zámerne inde —
// v jadrovom `modules/customers/customerConstants.js`, aby jadro nemuselo ťahať kód CRM
// (fáza 2b, Úloha C2).
//
